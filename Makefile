...
install-local-ora: ## installs your local ORA2 code into the LMS and Studio python virtualenvs
	...
	docker exec -t edx.devstack-olive.master.studio bash -c '. /edx/app/edxapp/venvs/edxapp/bin/activate && cd /edx/app/edxapp/edx-platform && pip uninstall -y ora2 && pip install -e /edx/src/edx-ora2 && pip freeze | grep ora2'
